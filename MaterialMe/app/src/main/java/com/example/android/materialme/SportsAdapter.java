...
class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.ViewHolder>  {
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            ...
            detailIntent.putExtra("detail_content", currentSport.getDetail());
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation((Activity) mContext,  mSportsImage,
                    "bannerImage");
